...
class GameTraitSeeder extends Seeder
{
    ...
    {
        return [
            // ── Traços de Atributo (point-buy, rarity=common) ──
            // O primeiro traço de cada grupo é o principal; os demais são sub-traços
            // dele — só ficam disponíveis depois que o principal é escolhido. Cada
            // traço (principal ou sub) aplica seu efeito completo, e eles acumulam:
            // ex. Poder 4 + Poderoso (+1) = 5; + Bruto (+1 Poder, -1 Fofo) = 6 Poder.
            // Poder
            ['slug' => 'poderoso', 'name' => 'Poderoso', 'category' => 'body', 'rarity' => 'common', 'description' => 'Excepcionalmente forte.', 'mechanical_effect' => '+1 Poder', 'sustento_cost' => 0, 'max_selections' => 1, 'modifiers' => [['attribute' => 'poder', 'operation' => 'add', 'value' => 1]], 'subs' => [
            ...
            // Graça
            ['slug' => 'gracioso', 'name' => 'Gracioso', 'category' => 'body', 'rarity' => 'common', 'description' => 'Excepcionalmente fino e ágil.', 'mechanical_effect' => '+1 Graça', 'sustento_cost' => 0, 'max_selections' => 1, 'modifiers' => [['attribute' => 'graca', 'operation' => 'add', 'value' => 1]], 'subs' => [
            ...
            // Casca
            ['slug' => 'duradouro', 'name' => 'Duradouro', 'category' => 'body', 'rarity' => 'common', 'description' => 'Resiliente e resistente.', 'mechanical_effect' => '+1 Casca', 'sustento_cost' => 0, 'max_selections' => 1, 'modifiers' => [['attribute' => 'casca', 'operation' => 'add', 'value' => 1]], 'subs' => [
            ...
            // Saber
            ['slug' => 'perspicaz', 'name' => 'Perspicaz', 'category' => 'senses', 'rarity' => 'common', 'description' => 'Perceptivo e inteligente.', 'mechanical_effect' => '+1 Saber', 'sustento_cost' => 0, 'max_selections' => 1, 'modifiers' => [['attribute' => 'saber', 'operation' => 'add', 'value' => 1]], 'subs' => [
            ...
            // Fofo
            ['slug' => 'lindo', 'name' => 'Lindo', 'category' => 'social', 'rarity' => 'common', 'description' => 'Agradável aos sentidos.', 'mechanical_effect' => '+1 Fofo', 'sustento_cost' => 0, 'max_selections' => 1, 'modifiers' => [['attribute' => 'fofo', 'operation' => 'add', 'value' => 1]], 'subs' => [
            ...
            // Assustador
            ['slug' => 'ameacador', 'name' => 'Ameaçador', 'category' => 'social', 'rarity' => 'common', 'description' => 'Desconfortante e ameaçador.', 'mechanical_effect' => '+1 Assustador', 'sustento_cost' => 0, 'max_selections' => 1, 'modifiers' => [['attribute' => 'assustador', 'operation' => 'add', 'value' => 1]], 'subs' => [
            ...
            // Deslocamento
            ['slug' => 'agil', 'name' => 'Ágil', 'category' => 'movement', 'rarity' => 'common', 'description' => 'Rápido e esperto.', 'mechanical_effect' => '+1 Deslocamento', 'sustento_cost' => 0, 'max_selections' => 1, 'modifiers' => [['attribute' => 'velocidade', 'operation' => 'add', 'value' => 1]], 'subs' => [
